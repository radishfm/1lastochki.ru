...
<div class="row">
	...
	<div class="styled-block1">
		<div class="maxwidth-theme">
			<div class="col-md-12">
				<div class="form contacts<?=($arResult['FORM_NOTE'] ? ' success' : '')?><?=($arResult['isFormErrors'] == 'Y' ? ' error' : '')?>  item-views">
					<!--noindex-->
					...
					<?else:?>
						...
						<div class="row">
							<div class="col-md-4">
								<?if($arResult["isFormTitle"] == "Y"):?>
									<h4 class="title"><?=$arResult["FORM_TITLE"]?></h4><br />
								<?endif;?>
							...
							<div class="col-md-8 col-sm-12" style="padding-top:59px;">
								<div class="row">
									...
									<?if($arResult["QUESTIONS"]["MESSAGE"]):?>
										<div class="col-md-6 col-sm-6">
											<?CAllcorp2::drawFormField("MESSAGE", $arResult["QUESTIONS"]["MESSAGE"], "INLINE_".$arResult["arForm"]["ID"]);?>
										</div>
									<?endif;?>
								</div>
