	...
	<div class="row margin0">
		<div class="maxwidth-theme">
			<div class="col-md-12">
				...
				$countmd = ($qntyItems > 4 ? 5 : ($qntyItems > 3 ? 4 : ($qntyItems > 1 ? 2 : 1)));
				...
				<div class="item-views partners front blocks">
					...
					<?endif;?>
					<div class="flexslider unstyled row flex_loader_circle navigation-vcenter dark-nav2" data-plugin-options='{"directionNav": true, "controlNav" :true, "animationLoop": true, <?=($bAnimation ? '"slideshow": true,' : '"slideshow": false,')?> <?=($slideshowSpeed >= 0 ? '"slideshowSpeed": '.$slideshowSpeed.',' : '')?> <?=($animationSpeed >= 0 ? '"animationSpeed": '.$animationSpeed.',' : '')?> "counts": [<?=$countmd?>, <?=$countsm?>, 1]}'>
