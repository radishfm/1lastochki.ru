										...
										<?if((isset($arItem['MIDDLE_PROPS']) && $arItem['MIDDLE_PROPS'])):?>
											<div class="middle-props">
												<?foreach($arItem['MIDDLE_PROPS'] as $key => $arProp):?>
													<div class="value">
													    <? switch ($arProp["CODE"]){
														case "EMAIL": echo '<!-- noindex --><a href="mailto:'.$arProp['VALUE'].'" target="_blank" rel="nofollow">'; break;
														case "PHONE": echo '<!-- noindex --><a href="tel:'.str_replace(array(' ', ',', '-', '(', ')'), '', $arProp['VALUE']).'" target="_blank" rel="nofollow">'; break;
													    }?>													    
													    <?=$arProp['VALUE'];?>
													    <? switch ($arProp["CODE"]){
														case "EMAIL":
														case "PHONE": echo '</a><!-- /noindex -->'; break;
													    }?>
													</div>
												<?endforeach;?>
											</div>
