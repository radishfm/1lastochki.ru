	...
	<?endif;?>
			<?foreach($arResult["ITEMS"] as $arItem):?>
				...
				<div class="col-md-<?=$colmd?> col-sm-<?=$colsm?> col-xs-<?=$colsm?>">
					<div itemprop="itemListElement" itemscope="" itemtype="http://schema.org/Product"  class="item<?=($bShowImage ? '' : ' wti')?>" id="<?=$this->GetEditAreaId($arItem['ID'])?>"<?=($bOrderViewBasket ? ' data-item="'.$dataItem.'"' : '')?>>
