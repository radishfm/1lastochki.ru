							...
							<?endif;?>
								<?foreach($arSection['ITEMS'] as $i => $arItem):?>
									...
									<?ob_start();?>
										...
										<?endif;?>
										<?if($arParams['FORM'] == 'Y'):?>
											<button class="btn btn-default" data-event="jqm" data-name="resume" data-param-id="<?=$arParams["FORM_ID"]?>" data-autoload-POST="<?=CAllcorp2::formatJsName($arItem['NAME'])?>" data-autohide=""><?=$arParams["FORM_BUTTON_TITLE"];?></button>
										<?endif;?>
												...
												<div class="body-info">
													...
													<?if($bDetailLink):?>
														<div class="link-block-more">
															<a href="<?=$arItem['DETAIL_PAGE_URL']?>" class="btn btn-default btn-sm"><?=GetMessage('TO_ALL')?></i></a>
														</div>
													<?endif;?>
												</div>
											</div>
