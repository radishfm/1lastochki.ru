...
<?if($arResult["PROPERTIES"]["SECTION"]["VALUE"]):?>
	<?$GLOBALS["arLandingSections"] = array("PROPERTY_SECTION" => $arResult["PROPERTIES"]["SECTIONS"]["VALUE"], "!ID" => $arResult["ID"]);?>
	<?$APPLICATION->IncludeComponent(
		"bitrix:news.list", 
		"landings_list", 
		array(
