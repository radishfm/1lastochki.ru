<?global $arTheme;?>
<?if($arParams["LIST_PRODUCT_BLOCKS_ORDER"] && strpos($arParams["LIST_PRODUCT_BLOCKS_ORDER"], 'map') === false)
{
	$arTmp = explode(',', $arParams["LIST_PRODUCT_BLOCKS_ORDER"]);
	$key = array_search('comments', $arTmp);
	if($key)
		unset($arTmp[$key]);
	$arTmp[] = 'map';
	$arTmp[] = 'comments';
	$arParams["LIST_PRODUCT_BLOCKS_ORDER"] = implode(',', $arTmp);
}
if($arParams["DETAIL_FIELD_CODE"] && !in_array("PREVIEW_PICTURE", $arParams["DETAIL_FIELD_CODE"]))
...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"FORM_ID_ORDER_SERVISE" => ($arParams["FORM_ID_ORDER_SERVISE"] ? $arParams["FORM_ID_ORDER_SERVISE"] : CAllcorp2::getFormID("aspro_allcorp2_order_project")),
		...
		"LIST_PRODUCT_BLOCKS_ORDER" => ($arParams["LIST_PRODUCT_BLOCKS_ORDER"] ? $arParams["LIST_PRODUCT_BLOCKS_ORDER"] : "sale,tab,gallery,services,reviews,staff,goods,map,comments"),
