...
<div class="search-page">
	<div class="searchinput">
		...
		<?}?>
			<button class="btn btn-search" type="submit" name="s" value="<?=GetMessage("SEARCH_GO")?>"><?=CAllcorp2::showIconSvg('search', SITE_TEMPLATE_PATH.'/images/svg/Search_black.svg');?></button>
