...
Asset::getInstance()->addJs('/bitrix/js/main/core/core_popup.js');
Asset::getInstance()->addCss('/bitrix/js/main/core/css/core_popup.css');
if($arResult["ITEMS"]){?>
	<div class="bx_filter bx_filter_vertical compact swipeignore">
		<div class="bx_filter_section clearfix">
			<div class="bx_filter_parameters_box active title">
				<div class="bx_filter_parameters_box_title filter_title titles"><?=Loc::getMessage("FILTER_TITLE_COMPACT");?></div>
			</div>
			...
			<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
				...
				//prices?>
				<div class="bx_filter_parameters_box prices<?=(isset($arResult['PRICE_SET']) && $arResult['PRICE_SET'] == 'Y' ? ' set' : '');?>" <?=isset($arResult['PRICE_HAVE']) ? '' : 'style="display: none;"'?>>
					<span data-f="<?=Loc::getMessage('CT_BCSF_SET_FILTER')?>" data-fi="<?=Loc::getMessage('CT_BCSF_SET_FILTER_TI')?>" data-fr="<?=Loc::getMessage('CT_BCSF_SET_FILTER_TR')?>" data-frm="<?=Loc::getMessage('CT_BCSF_SET_FILTER_TRM')?>" class="bx_filter_container_modef"></span>
					<div class="bx_filter_parameters_box_title icons_fa" >
