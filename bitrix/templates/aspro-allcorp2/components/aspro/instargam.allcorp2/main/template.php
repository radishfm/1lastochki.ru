				...
				<div class="container">
					...
					<div class="items row flexbox">
						...
						<?foreach ($arInstagramPosts['data'] as $arItem):?>
							<div class="item">
								<div class="image shine" style="background:url(<?=$arItem['images']['standard_resolution']['url'];?>) center center/cover no-repeat;"><a href="<?=$arItem['link']?>" target="_blank" title="<?=$arItem['caption']['text'];?>"></a></div>
							</div>
							<?if ($index == 3) break;?>
							<?++$index;?>
						<?endforeach;?>
